...
const ADB_EMPTY_DEVICE_STDOUT = 'List of devices attached\n\n';
...
module.exports.getBooleanFromString = (options, key) => {
  return options[key] && !utils.isTruthy(options[key]) ? false : (key in options);
};
...
module.exports.forceTrailingSlash = str => {
...
module.exports.isAdbDevicesListEmpty = adbDevicesStdOut => {
  return adbDevicesStdOut && adbDevicesStdOut === ADB_EMPTY_DEVICE_STDOUT;
};
